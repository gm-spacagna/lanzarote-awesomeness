...
cat $BRANCH_FILE | grep SBPINSIGHTS-[0-9]- > /dev/null
one_digit=$?
cat $BRANCH_FILE | grep SBPINSIGHTS-[0-9][0-9]- > /dev/null
two_digit=$?
cat $BRANCH_FILE | grep SBPINSIGHTS-[0-9][0-9][0-9]- > /dev/null
three_digit=$?
cat $BRANCH_FILE | grep SBPINSIGHTS-[0-9][0-9][0-9][0-9]- > /dev/null
four_digit=$?
