...
case object NeighbourToItemsRecommenderEvaluationJob {
  def main(args: Array[String]) {
    ...
    val recommenderTrainer =
      Neighbour2ItemRecommenderTrainer(sc, conf.minNumBusinessesPerCustomer(), conf.maxNumBusinessesPerNeighbour(),
