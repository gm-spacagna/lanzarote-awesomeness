...
case object Covariance {
  ...
  def features(records: RDD[AnonymizedRecord])(implicit minKTx: Int = 5): (RDD[(Long, Vector)], RDD[(Long, List[(String, String)])], Map[(String, String), Int]) = {
...
/*    (entries.keyBy(_._1._2).mapValues(v => List((v._1._1, v._2)))
  ...
  def toCovariance(features: RDD[(Long, Vector)]): Matrix = {
